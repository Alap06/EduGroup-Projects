...
<div class="col-lg-4 col-md-6 col-sm-12">
	...
	<center><h2 style="margin-top:1px;">Gestion des stagaiaires</h2></center>
		<form class="form-horizontal form-custom-login" action="" method="POST">
			<div class="form-heading">
			<h2 class="text-center">Interface d'authentification</h2>
			</div>
			...
			<input type="password" class="form-control rounded-0" placeholder="mot de passe" name="admin_password" required/>
			</div>
