    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom rounded-0">
          ...
          <center ><h3>Rapport des tâches par jour</h3></center>
          <div class="gap"></div>
            ...
            <table class="table table-codensed table-custom">
              ...
              <?php 
                if($user_role == 1){
                  ...
                  if($num_row==0){
                    echo '<tr><td colspan="7">No Informations found</td></tr>';
                  }
...
<noscript>
    <div>
        ...
        <h4 class="mb-0 text-center"><b>Gestion des staigiares</b></h4>
        <h4 class="mb-0 text-center"><b>Rapport des tâches quotidiennes</b></h4>
        <div class="mb-0 text-center"><b>de la date de </b></div>
