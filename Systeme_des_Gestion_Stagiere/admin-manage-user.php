...
<!--modal for employee add-->
  ...
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h2 class="modal-title text-center">Ajouter un stagiaire</h2>
    </div>
          ...
          <form role="form" action="" method="post" autocomplete="off">
            <div class="form-horizontal">
              ...
              <div class="form-group">
                <label class="control-label text-p-reset">Nom & Prenom</label>
                <div class="">
                  <input type="text" placeholder="Enter nom du stagiaire" name="em_fullname" list="expense" class="form-control input-custom" id="default" required>
                </div>
              </div>
               <div class="form-group">
                <label class="control-label text-p-reset">Username</label>
                <div class="">
                  <input type="text" placeholder="Username stagiaire..." name="em_username" class="form-control input-custom" required>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label text-p-reset">Email Stagiaire</label>
                <div class="">
                  <input type="email" placeholder="Email stagiaire.." name="em_email" class="form-control input-custom" required>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-3">
                  <button type="submit" name="add_new_employee" class="btn btn-primary btn-sm rounded-0">Ajouter Stagiaire</button>
                </div>
                <div class="col-sm-3">
                  <button type="submit" class="btn btn-default btn-sm rounded-0" data-dismiss="modal">Annuler</button>
                </div>
              </div>
            </div>
          </form> 
  ...
  <div class="col-md-12">
    ...
    <div class="well well-custom">
      ...
      <?php } ?>
        <?php if($user_role == 1){ ?>
            <div class="btn-group">
              <button class="btn btn-primary-custom btn-menu" data-toggle="modal" data-target="#myModal">Ajouter Stagiaire</button>
            </div>
          <?php } ?>
      <ul class="nav nav-tabs nav-justified nav-tabs-custom">
        <li><a href="manage-admin.php">Partie Admin</a></li>
        <li class="active"><a href="admin-manage-user.php">Partie Stagiaires</a></li>
      </ul>
      <div class="gap"></div>
        ...
        <table class="table table-codensed table-custom">
          ...
          <?php 
            ...
            $num_row = $info->rowCount();
              if($num_row==0){
                echo '<tr><td colspan="7">No Informations</td></tr>';
              }
